...
set shortmess=aoO
badd +1 Makefile
badd +65 includes/lemin.h
badd +1 srcs/read.c
badd +1 srcs/main.c
badd +25 srcs/links.c
badd +29 srcs/clear.c
...
wincmd w
argglobal
if bufexists('srcs/main.c') | buffer srcs/main.c | else | edit srcs/main.c | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 54 - ((50 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((32 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
